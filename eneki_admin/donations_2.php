...
if($result->num_rows>0)
{
    ...
    echo "<center><form action='donations2_search.php' method='POST'><input type='text' name='search' id='search' placeholder='Search....'><button type='submit' id='btn'>Search</button></form><center>";
    ...
    while($row=$result->fetch_assoc())
    {
        echo '<tbody>
        <tr class="active-row">
        <td><form action="donations2_delete.php" method="POST"><input type="text" name="id" class="hide" value="'.$row["emailid"].'" readonly>
