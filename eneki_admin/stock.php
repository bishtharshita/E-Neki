...
if($result->num_rows>0)
{
    ...
    echo "<center><form action='stock_search.php' method='POST'><input type='text' name='search' id='search' placeholder='Search....'><button type='submit' id='btn'>Search</button></form><center>";
    ...
    while($row=$result->fetch_assoc())
    {
        echo '<tbody>
        <tr class="active-row">
        <td><form action="stock_update.php" method="POST"><input type="text" name="id" class="hide" value="'.$row["item_id"].'" readonly>
        ...
        <td><button type="submit" id="b1"><img src="update.gif" height="24px" width="24px"></button></form></td>
