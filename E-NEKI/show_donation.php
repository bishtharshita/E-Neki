...
<div class="shopping-cart">
   ...
   <table>
      ...
      <tbody>
      <?php
      $cart_query = mysqli_query($conn, "SELECT * FROM `donation` WHERE `emailid` = '$user_id'") or die('query failed');
      $grand_total = 0;
      $sub_total=0;
      ...
      <?php
         ...
         echo '<tr><td style="padding:20px; text-transform:capitalize;" colspan="6">No Donations</td></tr>';
      }
      ?>
   ...
   <div class="cart-btn">  
      <a href="final product.html" class="btn  ?>">Back to Categories</a>
