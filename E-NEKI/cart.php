...
<div class="shopping-cart">
   ...
   <table>
      ...
      <tbody>
      <?php
      $cart_query = mysqli_query($conn, "SELECT * FROM `cart` WHERE `emailid` = '$user_id'") or die('query failed');
      $grand_total = 0;
      $sub_total=0;
   ...
   <div class="cart-btn">  
      ...
      <a href="#" onclick="test()" class="btn <?php echo ($grand_total == 0) ? 'disabled' : '' ; ?>">Proceed to Checkout</a>
